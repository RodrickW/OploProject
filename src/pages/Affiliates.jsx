      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              Devenez affilié Oplo.ai<br/>
              <span className="text-blue-600">et gagnez à vie</span>
            </motion.h1>
            ...
            >
              Rejoignez notre programme d'affiliation. Recommandez une fois, gagnez des commissions récurrentes à vie pour chaque restaurant que vous nous présentez.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Un programme simple et lucratif
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Vous recommandez les restaurants. Nous les accompagnons. Vous gagnez des commissions mensuelles récurrentes sur chaque affiliation réussie, aussi longtemps que vos clients restent avec nous.
            </p>
          </motion.div>
          ...
          >
            <div className="rounded-2xl bg-white border border-gray-200 shadow-xl p-8">
              <div className="flex items-center justify-between mb-8 pb-6 border-b border-gray-200">
                <h3 className="text-2xl font-bold text-gray-900">Votre tableau de bord d'affiliation</h3>
                <p className="text-gray-600">Suivez vos revenus et vos parrainages en temps réel</p>
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-4 rounded-lg bg-white border border-gray-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-bold text-gray-900">Restaurant Horizon</p>
                        <p className="text-sm text-gray-600">1156 commandes</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="font-bold text-gray-900">1 041 €</p>
                      <p className="text-sm text-gray-600">0,90 € par commande</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-3">S'inscrire</h4>
                <p className="text-gray-600">
                  Remplissez notre formulaire d'inscription rapide et dites-nous qui vous êtes et comment vous envisagez de recommander Oplo.ai à vos contacts dans la restauration.
                </p>
              </motion.div>
              ...
              >
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-3">Obtenir votre lien unique</h4>
                <p className="text-gray-600">
                  Une fois approuvé, vous recevez votre lien d'affiliation personnel et accédez à votre tableau de bord. Tout est prêt pour commencer à recommander.
                </p>
              </motion.div>
              ...
              >
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-3">Gagnez des commissions</h4>
                <p className="text-gray-600">
                  Chaque restaurant que vous recommandez et qui signe avec nous génère une commission mensuelle pour vous. Vos revenus augmentent au fur et à mesure que votre réseau grandit.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-8">
              Rejoignez notre programme d'affiliation et commencez à générer des revenus récurrents dès aujourd'hui.
            </p>
