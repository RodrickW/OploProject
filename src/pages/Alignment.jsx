...
const subPages = [
  ...
  { id: 'strategy', label: 'Stratégie', icon: Map },
  { id: 'reports', label: 'Rapports', icon: FileText },
  { id: 'insights', label: 'Insights', icon: Sparkles },
];

const statusConfig = {
  on_track: { label: 'En bonne voie', color: 'bg-emerald-500/20 text-emerald-400', icon: CheckCircle2 },
  at_risk: { label: 'À risque', color: 'bg-amber-500/20 text-amber-400', icon: AlertCircle },
  behind: { label: 'En retard', color: 'bg-red-500/20 text-red-400', icon: AlertCircle },
  completed: { label: 'Complété', color: 'bg-cyan-500/20 text-cyan-400', icon: CheckCircle2 }
};
...
export default function Alignment() {
  ...
  const displayGoals = goals.length > 0 ? goals : [
    { id: '1', title: 'Augmenter le CA de 20%', category: 'revenue', target_value: 3600000, current_value: 2520000, status: 'on_track', deadline: '2024-12-31' },
    { id: '2', title: 'Atteindre 50k clients', category: 'customer', target_value: 50000, current_value: 45280, status: 'on_track', deadline: '2024-12-31' },
    { id: '3', title: 'Ouvrir 2 nouveaux restaurants', category: 'expansion', target_value: 2, current_value: 0, status: 'at_risk', deadline: '2024-12-31' },
    { id: '4', title: 'Réduire turnover de 30%', category: 'team', target_value: 30, current_value: 18, status: 'on_track', deadline: '2024-12-31' },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-gray-500">Suivez vos objectifs stratégiques</p>
        </div>
      </div>
          ...
          <div className="rounded-xl bg-white border border-gray-200 p-6">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
              <div>
                ...
                <p className="text-sm text-gray-500">Objectifs annuels 2024</p>
              </div>
