...
const subPages = [
  { id: 'governance', label: 'Revues', icon: Calendar },
  { id: 'kpis', label: 'KPIs', icon: TrendingUp },
  { id: 'sops', label: 'SOPs', icon: ListTodo },
  { id: 'problems', label: 'Problèmes', icon: AlertCircle },
];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-gray-500">Standardiser • Piloter • Scaler • Déléguer sans perdre le contrôle</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="rounded-xl bg-white border border-gray-200 p-5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm text-gray-500">Problèmes ouverts</span>
              </div>
            ...
            <div className="rounded-xl bg-white border border-gray-200 p-5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm text-gray-500">Temps résolution moy.</span>
              </div>
              <p className="text-2xl font-bold text-gray-900">{stats.avgResolutionTime}j</p>
            </div>
            
            <div className="rounded-xl bg-white border border-gray-200 p-5">
              <div className="flex items-center gap-2 mb-3">
                <TrendingUp className="w-5 h-5 text-emerald-600" />
                <span className="text-sm text-gray-500">Efficacité opé.</span>
              </div>
